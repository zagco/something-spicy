...
const ProductsList = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const collectionRef = collection(db, 'products'); // Reference to the 'products' collection in Firestore
  ...
  return (
    <div  className='p-4 '>
      ...
      <h1 id="target-section" className='rakkas  text-5xl text-center'>All Our Products</h1>

<h2  className='rakkas text-3xl mt-9'>Top Deals of the Week</h2>
